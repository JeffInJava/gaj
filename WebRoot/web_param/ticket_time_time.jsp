<%@ page contentType="text/html; charset=gb2312" language="java" import="java.util.*,my.util.DateDemo,my.jsp.*" errorPage="errorpage.jsp" %>
...
String start_date=(String)request.getParameter("start_date");
	...
	if(start_date==null){
		...
		start_date=DateDemo.getYesterday();
	}else{
...
String end_date=(String)request.getParameter("end_date");
	...
	if(end_date==null){
		...
		end_date=DateDemo.getYesterday();
	}else{
...
<td style="BORDER-RIGHT: #000000 0px solid; BORDER-TOP: #000000 1px; PADDING-LEFT: 3px; FONT-WEIGHT: normal; FONT-SIZE: 12px; VERTICAL-ALIGN: middle; BORDER-LEFT: #000000 1px; COLOR: #000000; BORDER-BOTTOM: #000000 1px; FONT-STYLE: normal; FONT-FAMILY: 宋体; BACKGROUND-COLOR: #ffffff; TEXT-ALIGN: left; TEXT-DECORATION: none">票卡类型：</td>
    <td><select name="ticket" style="PADDING-LEFT: 0px; FONT-WEIGHT: normal; FONT-SIZE: 12px; VERTICAL-ALIGN: middle; WIDTH: 100px; COLOR: #000000; FONT-STYLE: normal; FONT-FAMILY: 宋体; HEIGHT: 20px; BACKGROUND-COLOR: #ffffff; TEXT-ALIGN: left; TEXT-DECORATION: none">
<option value='0'>全部</option>
<option value='1'>一卡通</option>
<option value='2'>单程票</option>
    </select></td>
</tr>
<tr>
