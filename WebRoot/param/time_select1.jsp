...
<td>
<select name="select" style="PADDING-LEFT: 0px; FONT-WEIGHT: normal; FONT-SIZE: 12px; VERTICAL-ALIGN: middle; WIDTH: 150px; COLOR: #000000; FONT-STYLE: normal; FONT-FAMILY: 宋体; HEIGHT: 20px; BACKGROUND-COLOR: #ffffff; TEXT-ALIGN: left; TEXT-DECORATION: none">
  <option value="0" selected>旧（不含新票种）</option>
  <option value="1">新（含新票种）</option>
</select>
</td>
</table>
</td>
