	...
	function check_cardid(){
			...
			if(cardid_v!=""){
				  ...
				  if((!cardid_v.match(Datereg))){
				     alert("输入票/卡号格式不对，正确的格式为10或11位数字");
				     return false;
					}else{
						return true;
					}
...
<td><input type=button value=查询 onclick="submit()" style="FONT-SIZE: 13px; WIDTH: 40px; COLOR: mediumblue; FONT-FAMILY: 宋体; HEIGHT: 22px; BACKGROUND-COLOR: wheat"></td>
</table>
