...
String urlString="http://10.37.5.122:8081/qf_report_new/report_page.jsp?report_name=halfhour_sum_flux&param_type=start_date_1_2_sum&report_name_cn=全日分时客流累计&"+"start_date_1="+start_date_1+"&start_date_2="+start_date_2;
//System.out.println("paramsString="+paramsString);
//System.out.println("urlString="+urlString);
%>
<META http-equiv=Refresh content="60; URL=<%=urlString%>"> 
<html>
<title>
全日分时客流累计
</title>
