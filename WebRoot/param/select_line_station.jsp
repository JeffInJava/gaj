...
function select() {
	with(document.form1.line_select) {
		...
		for(i = 0;i < where.length;i ++){
			if (where[i].line == loca2) {
				...
				for(j = 0;j < loca3.length;j++) {
					with(document.form1.station_select) {
					length = loca3.length;
		...
		if(loca2=="全线"){
			document.form1.line_id.value="";
			document.form1.station_id.value="";
		}else{
			document.form1.line_id.value=loca2.substring(1,3);
			document.form1.station_id.value=loca4.substring(1,5);
		}
}
