...
<td>
<select name="select" style="PADDING-LEFT: 0px; FONT-WEIGHT: normal; FONT-SIZE: 12px; VERTICAL-ALIGN: middle; WIDTH: 100px; COLOR: #000000; FONT-STYLE: normal; FONT-FAMILY: 宋体; HEIGHT: 20px; BACKGROUND-COLOR: #ffffff; TEXT-ALIGN: left; TEXT-DECORATION: none">
  <option value="2" selected>普通卡</option>
  <option value="0">计时计次卡</option>
  <option value="1">计时计费卡</option>
</select>
</td>
</table>
</td>
